...
import com.project.farmingappss.viewmodel.SocialMediaViewModel
...
//        viewModel.loadPosts()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.data.observe(viewLifecycleOwner) {
            adapter = SMPostListAdapter(activity!!.applicationContext, it)
...
//        smCreatePostFragment = SMCreatePostFragment()
        createPostFloating.setOnClickListener {
            val intent = Intent(context,SMPostAddingActivity::class.java)
